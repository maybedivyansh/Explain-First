                ...
                <div className="container-custom">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-stretch">
                        ...
                        <div className="relative border border-slate-200 rounded-lg p-6 bg-slate-50 shadow-sm flex flex-col h-full group">
                            ...
                            <div className="bg-white p-4 border border-slate-200 rounded shadow-sm flex-grow mb-4 opacity-50 relative overflow-hidden">
                                <div className="space-y-2">
                                    ...
                                    <p className="text-[10px] text-slate-400 mt-2 leading-tight text-justify">
                            ...
                            <div className="text-xs text-center text-red-500 font-medium bg-red-50 py-2 rounded">
                                289 words. Average reading level: College graduate.
                            </div>

                            <div className="absolute -bottom-3 left-1/2 -translate-x-1/2 bg-white px-3 py-1 shadow md:hidden">
                                vs
                            </div>
                        </div>

                        {/* RIGHT SIDE - Consent-First Solution */}
                        <div className="relative border-2 border-primary-blue/20 rounded-lg p-6 bg-indigo-50/30 shadow-md flex flex-col h-full ring-1 ring-primary-blue/5">
                            ...
                            <div className="text-xs text-center text-success font-medium bg-green-50 py-2 rounded mt-auto">
                                Explained in 45 seconds. Verified understanding.
                            </div>
                        </div>
